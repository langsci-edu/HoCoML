...
<p align="right">
<img src="./figures/slideQR.png" alt="drawing" style="width:350px;"/>
</p>
...
- 指令列的哲學：每個工具應該 do one specific task。根據不同需要在結合起來成為更彈性與強大的工具。如何結合？除了寫 `bash` **scripts**， 可以利用 **pipes** ！
...
寫一個小程式，叫做 `hi` 如下，然後 `chmod +x hi`，再進入背景執行 `./hi &`
...
- `sed` 可用來**搜尋與取代** (find and replace)，可與正則表示完美搭配。
